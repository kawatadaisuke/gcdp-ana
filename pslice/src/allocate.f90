...
subroutine allocate_smap_particle(nsp)
      use smap_particle
      ...
      allocate(vxsp(0:nsp-1))
      allocate(vysp(0:nsp-1))
      allocate(vzsp(0:nsp-1))
      allocate(masssp(0:nsp-1))
      allocate(psp(0:nsp-1))
      allocate(tempsp(0:nsp-1))
      allocate(mhsp(0:nsp-1))
      allocate(metsp(0:nsp-1))
      allocate(hsp(0:nsp-1))
