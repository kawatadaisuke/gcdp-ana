! *************************************************************
!    rdatav323.f  read data for the data from the code > ver.32.3
!  11 Mar. 2010  written by D.Kawata
! **************************************************************
!70*******************************************************************
...
subroutine rdata(step,ngt,ng,ndmt,ndm,ndm1t,ndm1,nst,ns &
      ...
      integer ndval,nival,nprocr,ndbhyd
...
! reading extra data
        ...
        open(51,file=filei,status='old',form='unformatted')
